---
name: agent-reach
description: Instala, configura, diagnostica y usa Agent Reach (repositorio open source Panniantong/Agent-Reach, MIT, gratis) para que Claude Code "lea Internet de verdad" — transcripciones y búsqueda en YouTube, tuits y búsquedas en X/Twitter, hilos y comentarios de Reddit, perfiles y empleos de LinkedIn, Facebook, Instagram, GitHub, RSS, cualquier web vía Jina Reader y búsqueda semántica con Exa, todo con un solo comando pegado en la terminal y sin coste de APIs. Úsala SIEMPRE que el usuario pida instalar, actualizar, configurar, reparar o desinstalar Agent Reach; que Claude lea, resuma, transcriba, busque o monitoree contenido de YouTube, TikTok/X/Twitter, Reddit, LinkedIn, Instagram, Facebook, un podcast o un RSS; que pregunte "qué dicen en Twitter/Reddit sobre…", "transcribe este video", "qué opina la gente de este producto", "sigue estas cuentas"; o cuando WebFetch falle con 403, login obligatorio o página vacía y haga falta acceso real a una plataforma cerrada. También para social listening, investigación de competencia y captura de fuentes para INNOVAQ (SIG360, ERP360, TPM360, AGRO360, FOOD360, HOTEL360, SALUD360, CATASTRO360, PMO360) y PANASUR. Use for any Agent Reach install/usage request or any task that needs Claude to read closed social platforms from the terminal.
---
