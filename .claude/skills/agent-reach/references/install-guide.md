# Guía oficial de instalación de Agent Reach (copia de referencia)

> Copia literal de `docs/install.md` del repositorio Panniantong/Agent-Reach, descargada el 2026-09-19.
> Es el documento que el video indica pegar en Claude Code. Antes de instalar en una máquina real,
> vuelve a descargar la versión vigente: `curl -s https://raw.githubusercontent.com/Panniantong/agent-reach/main/docs/install.md`.
> Está en inglés y chino; `comandos.md` tiene el resumen en español.
