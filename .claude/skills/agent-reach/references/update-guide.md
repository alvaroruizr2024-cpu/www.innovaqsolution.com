# Guía oficial de actualización de Agent Reach (copia de referencia)

> Copia literal de `docs/update.md` del repositorio Panniantong/Agent-Reach, descargada el 2026-09-19.
> Versión vigente: `curl -s https://raw.githubusercontent.com/Panniantong/agent-reach/main/docs/update.md`.
