---
name: youtube-reader
description: Lee y analiza el contenido de videos de YouTube (youtube.com, youtu.be, Shorts) y de artefactos de NotebookLM (resúmenes de video/audio compartidos con notebooklm.google.com) a partir de un enlace. Obtiene título, canal, descripción, capítulos, transcripción (subtítulos manuales o automáticos) y, si hace falta, descarga el video y extrae fotogramas para "verlo". Detecta primero si la red del entorno bloquea YouTube y aplica rutas alternativas (Google Drive, texto pegado por el usuario, política de red) en lugar de fallar. Úsala SIEMPRE que el usuario pegue un enlace de YouTube o NotebookLM, con o sin instrucciones, y siempre que pida "ver", "leer", "resumir", "transcribir", "qué dice", "sacar el título", "describir" o "publicar en la web" un video de YouTube. También cuando necesites el título real de un video para embeberlo en un sitio web. No la uses para videos locales o de Drive sin origen YouTube: para eso está la skill video-reader.
---
